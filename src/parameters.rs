...
// __________________________________Public parameters_______________________________________
// 2048-bit MODP Group described in RFC 3526:
...
pub const DATABASE: &str = "postgres://postgres:postgres@localhost/postgres";